...
void callback(char* byteArraytopic, byte* byteArrayPayload, unsigned int length) {
  ...
  if (topic == "FromMCU") { // OBS: der subscribes til et topic nede i reconnect-funktionen. I det her tilfælde er der subscribed til "LOCK". Man kan subscribe til alle topics ved at bruge "#"
